 ...
 IT Equipment Inventory System This project is a full-stack IT Equipment Inventory Management System built with Node.js, Express, MySQL (via Sequelize), and Vanilla JavaScript on the frontend. It allows organizations to efficiently track and manage hardware assets such as computers, printers, switches, and other IT devices. Features
